namespace FastAndFurious.ConsoleApplication.Common.Constants
{
    public class GlobalConstants
    {
        ...
        public const string SuccessFullyCreatedItem = "{0} - successfully created!";

        public const bool ThrowOnError = true;
        public const bool IgnoreCase = true;

        //Driver names
        public const string DominicRendetoName = "Dominic Rendeto";
        public const string LetiSpaghettiName = "Leti Spaghetti";
        public const string VinBenzinName = "Vin Benzin";
        public const string JessiName = "Jessi ";
        public const string VinceName = "Vince";
        public const string MiaName = "Mia";
    }
}
